...
const messages = {
  zh: {
    ...
    analysisFailed: '分析失败', ready: '准备开始分析', readyHint: '选择分析模式并添加论文，然后点击“开始分析”。',
    results: '分析结果', generating: '生成中…', editingMode: '编辑模式', edit: '编辑', copy: '复制', copied: '已复制', copyFailed: '复制失败', cancel: '取消', save: '保存', export: '导出', generatingPdf: '正在生成 PDF…',
  ...
  en: {
    ...
    analysisDetail: 'Analysis depth', simpleAnalysis: 'Brief', fullAnalysis: 'Full', simpleAnalysisHint: 'Quickly extract the core conclusions for an initial overview.', fullAnalysisHint: 'Keeps the complete analysis framework, equations, and evidence chain.',
    ...
    analysisFailed: 'Analysis Failed', ready: 'Ready for Analysis', readyHint: 'Select a mode, add your papers, and click Analyze.',
    results: 'Analysis Results', generating: 'Generating…', editingMode: 'Editing Mode', edit: 'Edit', copy: 'Copy', copied: 'Copied', copyFailed: 'Copy failed', cancel: 'Cancel', save: 'Save', export: 'Export', generatingPdf: 'Generating PDF…',
