...
const messages = {
  zh: {
    ...
    analysisFailed: '分析失败 😕', ready: '准备开始分析 😊', readyHint: '添加论文后，点击“开始分析”吧！',
    results: '分析结果 ✨', generating: '生成中… ☕', editingMode: '编辑模式 ✍️', edit: '编辑', copy: '复制', copied: '已复制 ✅', copyFailed: '复制失败 😕', cancel: '取消', save: '保存', export: '导出', generatingPdf: '正在生成 PDF… ⏳',
  ...
  en: {
    ...
    analysisFailed: 'Analysis Failed 😕', ready: 'Ready for Analysis 😊', readyHint: 'Add your papers, then click Analyze!',
    results: 'Analysis Results ✨', generating: 'Generating… ☕', editingMode: 'Editing Mode ✍️', edit: 'Edit', copy: 'Copy', copied: 'Copied ✅', copyFailed: 'Copy failed 😕', cancel: 'Cancel', save: 'Save', export: 'Export', generatingPdf: 'Generating PDF… ⏳',
