...
const messages = {
  zh: {
    subtitle: '📚 AI 驱动的学术论文分析', localClient: '🪄 本地 BYOK 客户端', language: '界面语言', settings: '⚙️ AI 服务设置',
    ...
    removeFile: '移除文件', addMoreFiles: '继续添加文件',
    fileReadError: '读取文件时发生错误。', startAnalysis: '🚀 开始分析', analyzingDocuments: '🧠 正在分析 {count} 篇文档…', needInput: '请至少上传一篇文档。',
    analysisFailed: '分析失败 ⚠️', ready: '准备开始分析 🌟', readyHint: '添加论文后，点击“开始分析”吧！',
    results: '分析结果 ✨', generating: '生成中… ☕', editingMode: '编辑模式 ✍️', edit: '编辑', copy: '复制', copied: '已复制 ✅', copyFailed: '复制失败 ⚠️', cancel: '取消', save: '保存', export: '导出', generatingPdf: '正在生成 PDF… ⏳',
    ...
    providerSettings: '⚙️ AI 服务设置', provider: '🤖 服务商', customProvider: '自定义 OpenAI 兼容接口', modelChoice: '模型（选择或自定义）', currentModel: '当前生效', notSet: '未设置',
  ...
  en: {
    subtitle: '📚 AI-Powered Academic Paper Analysis', localClient: '🪄 Local BYOK Client', language: 'Language', settings: '⚙️ AI Provider Settings',
    selectMode: 'Select Analysis Mode', authorMode: 'Author Style', directionMode: 'Research Direction', singlePaperMode: 'Single-Paper Technical Reading',
    authorDescription: "🧠 Extracts the author's unique writing style, methodologies, and academic signature.", directionDescription: '🧭 Analyzes the core research problem, contributions, and future trends of the field.', singlePaperDescription: '🔬 Technical and critical reading: equations, mechanisms, evidence, boundaries, and follow-up ideas.',
    analysisDetail: 'Analysis depth', simpleAnalysis: 'Brief 🌱', fullAnalysis: 'Full 🚀', simpleAnalysisHint: '✨ Extract the core conclusions and build an overall view.', fullAnalysisHint: '🔬 Keep the in-depth analysis, equations, and evidence chain.',
    ...
    removeFile: 'Remove file', addMoreFiles: 'Add more files',
    fileReadError: 'An error occurred while reading the files.', startAnalysis: '🚀 Start Analysis', analyzingDocuments: '🧠 Analyzing {count} document(s)…', needInput: 'Please upload at least one document.',
    analysisFailed: 'Analysis Failed ⚠️', ready: 'Ready for Analysis 🌟', readyHint: 'Add your papers, then click Analyze!',
    results: 'Analysis Results ✨', generating: 'Generating… ☕', editingMode: 'Editing Mode ✍️', edit: 'Edit', copy: 'Copy', copied: 'Copied ✅', copyFailed: 'Copy failed ⚠️', cancel: 'Cancel', save: 'Save', export: 'Export', generatingPdf: 'Generating PDF… ⏳',
    ...
    providerSettings: '⚙️ AI Provider Settings', provider: '🤖 Provider', customProvider: 'Custom OpenAI-Compatible', modelChoice: 'Model (select or enter a custom model)', currentModel: 'Active', notSet: 'Not set',
